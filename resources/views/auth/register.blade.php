                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="Tele" class="col-md-4 col-form-label text-md-right">Téléphone : </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="ville_idVille" id="ville_idVille">
                                      <option >ville</option>
                                        @foreach ($car_ville as $ville)
