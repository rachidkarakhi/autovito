                  ...
                  <div class="single_product">
                      ...
                      <div class="product_thumb">
                        <div class="ph" v-for="image in images">
                          ...
                          <a v-if="image.annance_numAnnance == annonce.numAnnance" class="primary_img"  ><img  height="200" width="200" @click="direct(annonce)" :src="'../../storage/'+image.nameImage" alt=""></a>
                          ...
                          <div class="left_caption">
                             <div class="product_name">
                               <ul>
                                  ...
                                  <li>pièce: @{{annonce.desPieace}}</li>
                                  <li>marque: @{{annonce.marque}}</li>
                                  <li>module: @{{annonce.module}}</li>
                                  <li>motorisation: @{{annonce.motorisation}}</li>
                                  <div v-for="ville in villes"  class="">
                                    <li v-if="ville.idVille ===annonce.ville_idVille " >Ville : @{{ville.nomVille}}</li>
                                  </div>
                                  </ul>
                              </div>
                                              ...
                                              <div class="action_links_btn">
                                                  ...
                                                  <ul>
                                                    <li class="wishlist">  <span style="color: #ffd54c;">
                                                        ...
                                                        <i title="Afficher plus de détailles" @click="direct(annonce)" class="far fa-2x  fa fa-plus"> </i>
                                                        </span>
                                                      </li>
                                                  <li class="quick_button">  <span style="color: #ffd54c;">

                                                      <i title="Ajouter à la liste de souhaits" @click="addToWishs(annonce)" class="far fa-2x  fa-heart"> </i>
                                                      </span>
                                                    </li>

                                                  <li class="wishlist">  <span style="color: #ffd54c;">

                                                      <i title="signaler un spam" @click="spamer(annonce)" class="far fa-2x  fa fa-ban"> </i>
                                                      </span>
                                                    </li>
  ...
  <script type="text/javascript">
    var a = new Vue({
      ...
      data:{
        ...
        selected_categories: {!! json_encode($cat) !!},
        selected_scategories: {!! json_encode($scat) !!},

        selected_categorie: {!! json_encode($cat) !!},
        selected_scategorie: {!! json_encode($scat) !!},
    ...
    pieces:[],
      ...
      methods:{
               ...
               getfac:function(){
                 ...
                 axios.get("http://127.0.0.1:8000/annonce/getfac")
                 .then(response=>{
                   this.marques=response.data.marque;
                   this.images=response.data.listImage;
                   this.categories=response.data.categorie;
